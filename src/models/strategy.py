...
class Strategy(Base, TimestampMixin):
    ...
    trade_count: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, default=None)
    max_drawdown: Mapped[Optional[float]] = mapped_column(Float, nullable=True, default=None)
    sharpe_ratio: Mapped[Optional[float]] = mapped_column(Float, nullable=True, default=None)
    win_rate: Mapped[Optional[float]] = mapped_column(Float, nullable=True, default=None)
