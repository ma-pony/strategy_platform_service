...
class RsiMeanReversionStrategy(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe["rsi"] < float(self.oversold.value)) & vol_ok, ["enter_long", "enter_tag"]] = [
            1,
            "rsi_oversold",
        ]
        dataframe.loc[(dataframe["rsi"] > float(self.overbought.value)) & vol_ok, ["enter_short", "enter_tag"]] = [
            1,
            "rsi_overbought",
        ]
